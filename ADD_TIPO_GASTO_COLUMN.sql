...
CREATE TABLE IF NOT EXISTS banco_categorias_gasto (
...
INSERT INTO banco_categorias_gasto (nombre) 
VALUES 
    ('Servicios Básicos'),
    ('Arriendo'),
    ('Sueldos'),
...
ALTER TABLE banco_categorias_gasto ENABLE ROW LEVEL SECURITY;

CREATE POLICY "Enable read access for all users" ON banco_categorias_gasto
    FOR SELECT USING (true);

CREATE POLICY "Enable insert for authenticated users" ON banco_categorias_gasto
