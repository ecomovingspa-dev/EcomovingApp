                    ...
                    <div className="flex-1 overflow-y-auto p-2 space-y-1">
                        {cargando ? (
                            ...
                            <div
                                ...
                                className={cn(
                                    "w-full text-left px-3 py-3 rounded-md text-xs font-medium transition-all flex items-center justify-between group outline-none cursor-pointer",
                                    selectedId === etapa.id
                            ...
                            >
                                <div className="flex items-center gap-3">
                                    <span className="inline-flex items-center justify-center h-5 w-5 rounded-full bg-violet-100 dark:bg-violet-900/30 text-violet-700 dark:text-violet-300 text-[10px] font-black">
                                        {etapa.orden}
                                    </span>
                                    <span>{etapa.etiqueta}</span>
                                    {!etapa.activo && (
                                        <span className="text-[9px] text-gray-400 italic">off</span>
                                    )}
                                </div>
                                ...
                                <div className="max-w-4xl mx-auto space-y-6">
                                    ...
                                    <div className="space-y-2">
                                        <div className="flex items-center gap-2">
                                            ...
                                            <span className="text-[9px] px-2 py-0.5 rounded-full bg-violet-50 dark:bg-violet-900/20 text-violet-500 border border-violet-200 dark:border-violet-800 font-mono">
                                                Variables: {"{empresa}"}, {"{correo}"}
                                            </span>
                                        </div>
                                        <Input
                                    ...
                                    <div className="space-y-2">
                                        <div className="flex items-center gap-2">
                                            <Label className="text-xs font-medium text-gray-700 dark:text-gray-300">Cuerpo del Mensaje</Label>
                                            <span className="text-[9px] px-2 py-0.5 rounded-full bg-violet-50 dark:bg-violet-900/20 text-violet-500 border border-violet-200 dark:border-violet-800 font-mono">
                                                Variables: {"{empresa}"}, {"{correo}"}, {"{dominio}"}
                                            </span>
                                        </div>
                                        <Textarea
                                    ...
                                    {/* Cierre */}
                                    <div className="space-y-2">
                                        <Label className="text-xs font-medium text-gray-700 dark:text-gray-300">Mensaje de Cierre / CTA</Label>
                                        <Textarea
